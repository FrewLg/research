...
final class FileNamer implements NamerInterface{
    ...
    public function name($object, PropertyMapping $mapping): string
    {
        ...
        $smartName = \sprintf('%s%s', "Proposal", $uniqExtension);
        ...
        if (\strlen($uniqExtension) <= 254) {
            ...
            return \sprintf('%s%s', "Proposal", $uniqExtension);
        }
        ...
        return \sprintf('%s%s.%s', "Proposal", $uniqId, $shortExtension);
    }
}
