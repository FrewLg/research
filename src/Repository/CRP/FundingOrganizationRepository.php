...
class FundingOrganizationRepository extends ServiceEntityRepository
{
     ...
     */
    public function add(FundingOrganization $entity, bool $flush = true): void
    {
     ...
     * @throws OptimisticLockException
     */
    public function remove(FundingOrganization $entity, bool $flush = true): void
    {
    ...
    // /**
    //  * @return FundingOrganization[] Returns an array of FundingOrganization objects
    //  */
    /*
    ...
    */
    ...
    /*
    public function findOneBySomeField($value): ?FundingOrganization
    {
        return $this->createQueryBuilder('f')
            ->andWhere('f.exampleField = :val')
            ->setParameter('val', $value)
