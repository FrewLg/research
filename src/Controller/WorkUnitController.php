...
class WorkUnitController extends AbstractController {
     ...
     */
    public function show(Request $request, WorkUnit $workUnit, ThematicAreaRepository $thematicAreaRepository, GuidelinesRepository $guidelinesRepository): Response {
