...
class IRBReviewAssignmentController extends AbstractController
{
     ...
     */
    public function assign(Request $request, Application $submission ,ReviewHelper $reviewHelper, 
     
    MailerInterface $mailer,  IRBReviewAssignmentRepository $reviewAssignmentRepository): Response
    {
    ...
    $the_submission_author=$submission->getSubmittedBy();
...
// dd($messages );
        $form = $this->createForm(IRBReviewAssignmentType::class, $reviewAssignment);
